...
exports.postPlayer=async (req,res,next)=>{
    try {
        const { Name, Dob, Photourl, Birthplace, Numberofmatches,Score,Fifties,Centuries,Wickets,Average,Description } = req.body;

        const player = await Player.create({ Name,Dob,Photourl, Birthplace,Numberofmatches,Score,Fifties,Centuries,Wickets,Average,Description});
